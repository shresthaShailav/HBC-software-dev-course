...
public class Query implements Observer {
    ...
    public void update(Observable o, Object arg) {
        Status receivedStatus = (Status) arg;
        if(filter.matches(receivedStatus)) {
            map.addMapMarker(new MapMarkerCustomA(layer, util.Util.statusCoordinate(receivedStatus), color, receivedStatus));
        }
