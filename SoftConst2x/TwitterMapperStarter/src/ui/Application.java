    ...
    public Application() {
        ...
        map().addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                List<MapMarker> listOfMapMarker = getMarkersCovering(pos, pixelWidth(p));
                MapMarkerCustomA selectedMarker = (MapMarkerCustomA) listOfMapMarker.get(0);
                String text = selectedMarker.getStatus().getText();
